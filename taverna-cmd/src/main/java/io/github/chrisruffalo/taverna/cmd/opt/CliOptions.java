package io.github.chrisruffalo.taverna.cmd.opt;
...
public class CliOptions implements Options {
    ...
    @Parameter(names = {"-p", "--storepass"}, defaultValueDescription = "The default value is '" + Options.DEFAULT_STORE_PASSWORD + "'.", description = "The default password to use for all Java trust stores that are specified without providing a password.")
